...
# Import API URL from config (generated by setup.py)
try:
    from ui.config import SCRAPER_API_URL
    API_BASE = SCRAPER_API_URL
except ImportError:
    API_BASE = "https://tangentleman--content-scraper-api-fastapi-app.modal.run"

# Allow env var override
API_BASE = os.environ.get("SCRAPER_API_URL", API_BASE)
